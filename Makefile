...
ifeq ($(OS),Windows_NT)
	...
	gcc image_viewer/c_extensions/util/os_posix.c image_viewer/c_extensions/b64/cencode.c -L$(PYTHON_LIB_PATH) -I/usr/include/python3.12 -Iimage_viewer/c_extensions/ -lpython3.12 -lX11 -fPIC -O3 -fno-signed-zeros -s -shared -o image_viewer/util/_os_posix.so -Wall -Werror
endif
